...
// const bul = document.querySelector('.mw-category')
// const bulArr = Array.from(bul.querySelectorAll('a'))
// const textBulArr = bulArr.map((e) => e.textContent)

// const filtered = textBulArr.filter(e=> e.includes('de'))
